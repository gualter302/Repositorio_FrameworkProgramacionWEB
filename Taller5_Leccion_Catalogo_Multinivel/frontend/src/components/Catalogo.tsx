...
const Catalogo = () => {
  ...
  // La categoría se deriva de la URL (?categoria=...) en lugar de copiarse a un useState:
  // así la URL es la única fuente de verdad y el filtro se actualiza aunque se navegue
  // desde el Sidebar o desde el Storefront estando ya en /catalogo.
      ...
      {productosFiltrados.length === 0 ? (
        <div className="bg-white p-10 rounded-lg border border-slate-200 text-center">
          ...
          <button
            onClick={() => {
              setBusqueda("");
              setSearchParams({}); // sin ?categoria= -> "Todas"
            }}
